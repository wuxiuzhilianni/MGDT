...
def eval_model(args):
    ...
    for i in tqdm(range(0,len(questions),args.batch_size)):
        ...
        with torch.inference_mode():
            ...
            # output_ids = model.generate( final_input_tensors, images=image_tensor_batch.half().cuda(), do_sample=True , temperature=args.temperature, top_p=args.top_p, num_beams=1, max_new_tokens=256,length_penalty=2.0, use_cache=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/workspace/animax/GeoChat/geochat_weights")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-folder", type=str, default="/workspace/Dataset/DOTAv1_Split/split_ss_dota/trainval/images")
    parser.add_argument("--question-file", type=str, default="/workspace/animax/GeoChat/data/dota/dota_trainval_questionv1.jsonl")
    parser.add_argument("--answers-file", type=str, default="/workspace/animax/GeoChat/data/dota/dota_trainval_answerv1_dosampletrue_tp0.5.jsonl")

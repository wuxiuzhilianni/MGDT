...
def eval_model(args):
    ...
    print(f"Model size: {num_params / 1e9:.2f} billion parameters")
    ...
    # 打印时间信息
    print(f"⏱️  Total inference time for 100 images: {total_time:.2f} seconds")
    print(f"🖼️  Average time per image: {total_time / 100:.2f} seconds")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="/workspace/GeoChat/data/dota/class_prompt/dota_trainval_questionv1.jsonl")
    parser.add_argument("--answers-file", type=str, default="/workspace/GeoChat/data/dota/class_prompt/test_speed.jsonl")

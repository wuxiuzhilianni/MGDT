...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="/workspace/GeoChat/data/dota/pseudo_box/grounding_method1/xx_question.jsonl")
    parser.add_argument("--answers-file", type=str, default="/workspace/GeoChat/data/dota/pseudo_box/grounding_method1/xx_answer.jsonl")

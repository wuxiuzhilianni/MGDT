...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-file", type=str, default="/workspace/GeoChat/data/dota/test_different_question/box_question_dota.jsonl", help="输出jsonl文件的路径"
    )
    parser.add_argument(
        "--text", type=str, default="Detect the following 15 object categories: plane, baseball-diamond, bridge, ground-track-field, small-vehicle, large-vehicle, ship, tennis-court, basketball-court, storage-tank, soccer-ball-field, roundabout, harbor, swimming-pool, helicopter. Give the category and rotated location.", help="自定义的text内容"
    )

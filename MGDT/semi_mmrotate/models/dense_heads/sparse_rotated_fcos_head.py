...
class SparseRotatedFCOSHead(RotatedFCOSHead):
    def __init__(self, num_classes, in_channels, **kwargs):
        super(SparseRotatedFCOSHead, self).__init__(
            num_classes,
            in_channels,
            **kwargs)
    ...
    def forward_train(self,
        ...
        return super(SparseRotatedFCOSHead, self).forward_train(
            x,
            img_metas,
            gt_bboxes,
            gt_labels=gt_labels,
    ...
    def loss(self,
        ...
        loss_cls = self.loss_cls(
            flatten_cls_scores, flatten_centerness, flatten_labels, avg_factor=num_pos)

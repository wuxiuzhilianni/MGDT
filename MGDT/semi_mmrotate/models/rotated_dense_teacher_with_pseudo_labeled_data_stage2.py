...
class RotatedDenseTeacherWithPseudoLabeledDataStage2(RotatedSparseDetector):
    def __init__(self, model: dict, semi_loss_unsup, semi_loss_sup, train_cfg=None, test_cfg=None, symmetry_aware=False):
        super(RotatedDenseTeacherWithPseudoLabeledDataStage2, self).__init__(
    ...
    # Stage2 中读取 Stage1 的最优权值开始生成伪标签
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedDenseTeacherWithPseudoLabeledDataStage2, self).forward_train(imgs, img_metas, **kwargs)

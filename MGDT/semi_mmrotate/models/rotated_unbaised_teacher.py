...
class RotatedUnbaisedTeacher(RotatedSemiDetector):
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedUnbaisedTeacher, self).forward_train(imgs, img_metas, **kwargs)

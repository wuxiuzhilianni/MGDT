...
class RotatedDenseTeacherWithPseudoLabeledData3Branch(RotatedSparseDetector):
    def __init__(self, model: dict, semi_loss_unsup, semi_loss_sup, train_cfg=None, test_cfg=None, symmetry_aware=False):
        super(RotatedDenseTeacherWithPseudoLabeledData3Branch, self).__init__(
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedDenseTeacherWithPseudoLabeledData3Branch, self).forward_train(imgs, img_metas, **kwargs)

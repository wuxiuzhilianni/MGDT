...
class RotatedDenseTeacherVisual(RotatedSemiDetector):
    def __init__(self, model: dict, semi_loss, train_cfg=None, test_cfg=None, symmetry_aware=False):
        super(RotatedDenseTeacherVisual, self).__init__(
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedDenseTeacherVisual, self).forward_train(imgs, img_metas, **kwargs)
        ...
        if self.iter_count > self.burn_in_steps:
            ...
            unsup_losses = self.semi_loss(teacher_logits, student_logits, ratio=self.region_ratio, img_metas=format_data['unsup_weak'], iter=self.iter_count)

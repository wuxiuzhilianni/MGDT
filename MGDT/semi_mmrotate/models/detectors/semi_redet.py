import torch
from mmrotate.models import ReDet, ROTATED_DETECTORS, RotatedTwoStageDetector
from mmrotate.models.builder import build_loss


@ROTATED_DETECTORS.register_module()
class SemiReDet(ReDet):
    ...
    def forward_train(self,
        ...
        x = self.extract_feat(img) # TODO ReFPN中这里的维度为256到16
        ...
        if not get_boxes:
            ...
            # TODO
            for i, bbox_head in enumerate(self.roi_head.bbox_head):
                bbox_head.loss_cls = loss_cls_list[i] 
        ...
        with torch.no_grad():
            ...
            # TODO 调用 RoITransRoIHeadSparse 的 simple_test_bboxes 函数获取伪标签

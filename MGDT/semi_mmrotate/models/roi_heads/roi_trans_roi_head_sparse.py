...
from mmrotate.models import ROTATED_HEADS, build_head, build_roi_extractor

# TODO 由于原始的 RoITransRoIHead 没有 simple_test_bboxes 函数，这里将原来的 simple_test 中的代码逻辑抽到 simple_test_bboxes 中

@ROTATED_HEADS.register_module()
class RoITransRoIHeadSparse(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(RoITransRoIHeadSparse, self).__init__(init_cfg)
...
# TODO 将原始 RoITransRoIHead 中的 simple_test 函数进行拆分，调用 simple_test_bboxes 获取 bbox

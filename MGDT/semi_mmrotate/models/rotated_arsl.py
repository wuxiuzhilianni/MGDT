...
class RotatedARSL(RotatedSemiDetector):
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedARSL, self).forward_train(imgs, img_metas, **kwargs)
        ...
        if self.iter_count > self.burn_in_steps:
            ...
            unsup_losses = self.semi_loss(teacher_logits, student_logits, img_metas=format_data['unsup_weak'])

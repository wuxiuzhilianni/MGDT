...
model = dict(
    type="RotatedARSL",
    model=detector,
    semi_loss=dict(type='RotatedARSLLoss', loss_type='origin', bbox_loss_type='l1'),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=12800,
        sup_weight=1.0,
...
evaluation = dict(type="SubModulesDistEvalHook", interval=3200, metric='mAP',
                  save_best='mAP')
# evaluation = dict(type="SubModulesEvalHook", interval=3200, metric='mAP',
#                   save_best='mAP') # Single GPU

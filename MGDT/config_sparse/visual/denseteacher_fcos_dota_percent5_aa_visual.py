...
model = dict(
    type="RotatedDenseTeacherVisual",
    model=detector,
    semi_loss=dict(type='RotatedDTLossAssignerAssistentV3Visual', loss_type='origin', bbox_loss_type='l1'),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=0, # TODO
        sup_weight=1.0,
        unsup_weight=1.0,
...
weak_pipeline = [
    ...
    dict(
        ...
        flip_ratio=[0.000001, 0.000001, 0.000001],
...
# evaluation
evaluation = dict(type="SubModulesDistEvalHook", interval=9600, metric='mAP',
                  save_best='mAP')

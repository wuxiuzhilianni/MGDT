...
model = dict(
    ...
    model=detector,
    semi_loss=dict(type='RotatedDTLoss', cls_channels=1, loss_type='origin', bbox_loss_type='l1'),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=6400,
        sup_weight=1.0,
...
data_root = '/workspace/Dataset/HRSC2016/'
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            ...
            ann_subdir=data_root + 'FullDataSet/Annotations5%/',
